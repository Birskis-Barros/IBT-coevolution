...
for i= 1:54
    ...
    R"""
        ...
        result = result_first_ext
        result$n_sec = result_sec_ext$n_sec

        file_path = paste("/Users/irinabarros/Dropbox/PhD/IBT_Coevolution/Results/new/first_and_secondary_ext/network", $i, ".csv", sep="")
        write.csv(result, file=file_path)
        ...
        # filename = paste("network_", $i, ".pdf", sep="")

        # ggsave(filename, figure, path="/Users/irinabarros/Dropbox/PhD/IBT_Coevolution/Graphs/Pos_Quals/first_and_secondary_ext/", width=20, height = 10)
    """
end
