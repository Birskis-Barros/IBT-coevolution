...
for m=2:54 #number of networks in the analysis
      ...
      #primeira int do loop (m=1) rodar fora do loop e colocar total=new20
            R"""
            total = rbind(total,new20)
            write.csv(total, file=("/home/irinabarros/IBT_coev/Results/R_sp_var_traj_net1_54.csv"))
