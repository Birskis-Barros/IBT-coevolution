...
@everywhere include("$(homedir())/Dropbox/PhD/IBT_Coevolution/Codes/IBT-coevolution/analysis/new/Difusion_networks/laplacian.jl")
@everywhere include("$(homedir())/Dropbox/PhD/IBT_Coevolution/Codes/IBT-coevolution/analysis/new/Difusion_networks/eigencluster.jl")

path = string("$(homedir())/Dropbox/PhD/IBT_Coevolution/Results/new/structure_networks_mainland/network_1.csv");
data = CSV.File("all_networks_combined.csv", header=1)|> DataFrame;
