...
event = 600; #coevolutionary time step
...
m = 144; #chossing network from data folder
...
#ncolumns = tmax
analy = assemblycoev(adj_network, phi, mi, alfa, event, ext_size, col_rate, maximumprob);
